...
/* UART ------------------------------- */
#define _UART
#define _UART0 /* ft2232 */
//#define _UART1 /* uart breakout */
//#define _UART2 
//#define _UART3

/* SPI ------------------------------- */
#define _SPI /* to gumstix (maybe) */

/* SYSTICK --------------------------- */
#define _SYSTICK /* blinking LED */

/* SSP ------------------------------- */
#define _SSP
#define _SSP0 /* to gumstix */
//#define _SSP1
...
#define _I2C
//#define _I2C0
#define _I2C1 /* ADSblahblah power meter */
//#define _I2C2
...
/* GPDMA ------------------------------- */
#define _GPDMA /* to Gumstix auto-transfer (maybe) */
